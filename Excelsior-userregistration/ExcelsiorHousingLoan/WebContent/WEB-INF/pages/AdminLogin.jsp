...
<meta name="viewport"
	content="width=device-width,initial-scale=1,user-scalable=yes, maximum-scale=1,user-scalable=no">
<script
...
<link rel="stylesheet" type="text/css"
	href="jquery-ui-1.10.3/themes/base/jquery.ui.all.css" />
...
<body>
	...
	<div class="col-md-12 col-xs-12 bg-text">
		<form action="adminLogin.do" method="post" id="adminlogin">
